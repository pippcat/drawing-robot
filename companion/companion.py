...
def draw_simulation(image):
    ...
    drawing_simulator.draw_image(scenery['alphaLabel'], scenery['betaLabel'], scenery['innerArmLabel'], scenery['outerArmLabel'],scenery['innerArm'], scenery['outerArm'], scenery['innerLength'],scenery['outerLength'],scenery['image'], scenery['image_scale'])
